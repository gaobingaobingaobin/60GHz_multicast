function [ d_s] = beam_gen_weakest_first(RX_measure_report, RX_log_measure_report,Beam_index_report, k)
%BEAM GROUP GENERATION SELECTING WEAKEST CLIENT FIRST
    ...
    while(sum(served) < N_u)
       ...
       beam_count = beam_count + 1;
        ...
        [~,ind] = min(squeeze(RX_log_measure_report(k+1,unserved_locs)));
